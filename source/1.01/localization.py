...
TRANSLATIONS = {
    'ru': {
        ...
        'instruction_content': """----------------------------------
ИНСТРУКЦИЯ ПО ПЕРЕВОДУ МИССИЙ DCS World
----------------------------------
...
Задача:
Перевести текст на РУССКИЙ ЯЗЫК максимально точно, без художественных вольностей.
...
Вот текст для перевода:"""
    ...
    'en': {
        ...
        'instruction_content': """----------------------------------
DCS World MISSION TRANSLATION GUIDE
----------------------------------
...
🟪 TRANSLATE (ATTENTION! THE NUMBER OF LINES IN THE TRANSLATION MUST STRICTLY MATCH THE NUMBER OF LINES IN THE ORIGINAL TEXT WINDOW)
-----
