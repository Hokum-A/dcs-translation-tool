...
v1.01 - Выбор папки при перезаписи, исправление LRM, динамическая версия
    ...
    def save_miz_overwrite(self, target_folder):
        ...
        try:
            ...
            if self.create_backup:
                ...
                # Логика инкрементальных бэкапов:
                # .backup -> .backup1 -> .backup2 -> ...
                base_backup_path = self.current_miz_path + '.backup'
