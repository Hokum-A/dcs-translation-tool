...
class LuaTranslationWindow(CustomDialog):
    ...
    def _setup_ui(self):
        ...
        self.copy_btn = QPushButton(get_translation(lang, 'lua_copy_all'))
        self.copy_btn.setFixedSize(180, 32)
        self.copy_btn.setCursor(Qt.PointingHandCursor)
        self.copy_btn.setStyleSheet(btn_style_white)
        self.copy_btn.setEnabled(False)
        self.copy_btn.clicked.connect(self._copy_all)
        left_layout.addWidget(self.copy_btn, 0, Qt.AlignLeft)
    ...
    def _copy_all(self):
        ...
        if self.context_enabled and self.ai_context and self.ai_context.strip():
            text = self.ai_context.strip() + "\n\n" + text
