...
class NumberedTextEdit(QPlainTextEdit):
    ...
    def keyPressEvent(self, event):
        ...
        if event.key() == Qt.Key_V and event.modifiers() & Qt.ControlModifier:
            ...
            import re
            if clipboard_text and re.search(r'🔹\d+🔹', clipboard_text):
    ...
    def insertFromMimeData(self, source):
        ...
        import re
        if source.hasText() and re.search(r'🔹\d+🔹', source.text()):
            p = self.parent()
            while p:
                if hasattr(p, 'handle_smart_paste_request'):
...
class PreviewTextEdit(QPlainTextEdit):
    ...
    def insertFromMimeData(self, source):
        ...
        import re
        if not self.isReadOnly() and source.hasText() and re.search(r'🔹\d+🔹', source.text()):
