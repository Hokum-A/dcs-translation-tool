...
class FileManagerWidget(QWidget):
    ...
    def _init_status_bar(self, parent_layout):
        ...
        lbl_style = "color: #aaaaaa; font-size: 11px; font-weight: bold; border: none; background: transparent;"
        val_style = "color: #ff9900; font-size: 11px; font-weight: bold; border: none; background: transparent;"
    ...
    def _on_tts_clicked(self, row):
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            if generated_path and os.path.exists(generated_path):
                ...
                # Плавное обновление вместо _populate_table()
                self._all_files = self.miz_resource_manager.get_all_resource_files()
                row = -1
                for r in range(self.table.rowCount()):
                    it = self.table.item(r, self.COL_FILENAME)
