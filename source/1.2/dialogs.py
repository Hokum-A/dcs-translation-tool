...
class MizFolderDialog(CustomDialog):
    ...
    def __init__(self, folders, current_language, parent=None, default_selection=None):
        ...
        desc_label.setStyleSheet("color: #bbbbbb; font-size: 11px; background-color: transparent; border: none;")
...
class AudioPlayerDialog(CustomDialog):
    ...
    def setup_ui(self):
        ...
        self.playlist_widget = AudioPlaylistWidget(self.current_language, self, shared_duration_cache=self.shared_duration_cache)
