...
"""
    ...
    def load_settings(self):
        ...
        if os.path.exists(self.settings_file):
            try:
                ...
                self.bookmark_bg_opacity = settings.get('bookmark_bg_opacity', 0.40)
    ...
    def save_settings(self, force=False, update_preview=True, update_ui=True):
        ...
        try:
            ...
            settings = {
                ...
                'bookmark_bg_opacity': getattr(self, 'bookmark_bg_opacity', 0.40),
    ...
    def _get_bookmark_visual(self, key):
        ...
        if bm:
            ...
            opacity = getattr(self, 'bookmark_bg_opacity', 0.40)
