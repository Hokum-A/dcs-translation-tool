...
from PyQt5.QtGui import (
    ...
    QRegion, QTextCursor, QPixmap, QPen, QPolygon, QCursor
)
    ...
    def contextMenuEvent(self, event):
        ...
        if cursor.hasSelection():
            ...
            if main_window:
                ...
                find_action.triggered.connect(lambda: main_window.start_find_replace(selected_text, focus_type='find'))
                
                replace_action = menu.addAction("Replace")
                replace_action.triggered.connect(lambda: main_window.start_find_replace(selected_text, focus_type='replace'))
...
class CheckboxHeader(QHeaderView):
    ...
    def _get_checkbox_rect(self, section_rect):
        ...
        return QRect(
            section_rect.left() + (section_rect.width() - cb_size) // 2 - 2,
