import os
from PyQt5.QtWidgets import QWidget, QPlainTextEdit, QScrollBar, QLineEdit, QCheckBox, QLabel, QHBoxLayout, QFrame, QVBoxLayout, QScrollArea, QSizePolicy, QMenu, QSlider
