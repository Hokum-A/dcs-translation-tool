...
"""
    ...
    def setup_preview_panel(self, parent_container):
        ...
        self.preview_splitter.setHandleWidth(8)  # Увеличили область захвата
    ...
    def dropEvent(self, event):
        ...
        if ext == '.miz':
            ...
            # Для всех остальных файлов (включая файлы без расширения, как 'dictionary')
            # вызываем универсальный загрузчик, который сам определит тип по контенту
