...
class SettingsWindow(CustomDialog):
    ...
    def __init__(self, current_language, parent=None):
        ...
        ref_label_text = 'Референс-локаль' if self.current_language == 'ru' else 'Reference locale'
        ...
        self.reference_locale_combo.setStyleSheet("""
            QComboBox {
        ...
        try:
            if self.parent_window and getattr(self, '_orig_parent_values', None):
                ...
                try:
                    ...
                    self._log_debug(f"  - reference_locale restored")
                except Exception as e:
